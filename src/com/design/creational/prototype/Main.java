...
public class Main {
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        //All the below two-wheeler vehicals have different hashcodes as
        // clones are created when each time the new object is requested
        System.out.println(registry.getVehicle("TWO").hashCode());
        System.out.println(registry.getVehicle("TWO").hashCode());
        System.out.println(registry.getVehicle("TWO").hashCode());
    }
}
